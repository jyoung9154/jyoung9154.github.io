...
- `[확인 1]` Korean Agent Skills 오픈소스 — 현재도 120+개가 맞는지, 저장소 링크
- `[확인 2]` JIRA-AI 서사 — "자동 패치를 즉시 적용하지 않고 검증 게이트+사람 승인 뒤에 둔다"는 표현이 실제와 맞는지 (사이트 내용에서 추론한 초안)
- `[확인 3]` "수백만 사용자" 규모 표현 (3월 PDF의 "500만+ 사용자" 기반) 사용 가능 여부
- `[확인 4]` 학력 기간 표기 (3월 PDF 기준)
