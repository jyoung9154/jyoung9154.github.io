...
const HIGHLIGHTS = [
    { head: 'JIRA-AI 사내 단독 개발', rest: 'LLM 한 번 호출을 LangGraph4j 15노드 워크플로로 키우고, 지식 승인 격리와 DLT 재접수로 틀린 답과 실패가 굳지 않게 했습니다' },
    { head: '메일 3계층 안정화', rest: 'Kafka로 발송결과를 보여주고, 탈취 의심 계정을 조회하고, 중간에 멈출 수 있는 대량 삭제 잡과 SSL 인증서 자동 반영을 만들었습니다' },
    { head: 'MCP·AI 연결', rest: '메일 MCP 게이트웨이로 에이전트가 메일을 읽게 하고, AI 내부유출 검증을 발송 승인에, 도메인 구축을 담당자 승인 자동화에 연결했습니다' },
    { head: '전자결재·이관', rest: '열람 권한 API와 결재선 상태 표시를 만들고, 그룹별 데이터소스와 부분 재개, SSE 진행 표시가 있는 이관 도구를 만들었습니다' },
];
