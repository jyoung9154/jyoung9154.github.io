    ...
    return (
        <div className="career-container">
            <article>
                ...
                - 기술 스택 : Java(Spring), Spring Boot, JSP, React, MySQL, Redis, Git, SVN, Docker, k8s <br/>
                <b style={{ fontSize: '16px' }}>2.그룹웨어 전자결재 마이그레이션 개발 및 운영 담당</b><br/>
                - 기술 스택: Linux, Spring Boot(JPA), React, MySQL, MSSQL, Oracle DB, Git<br/>
                <b style={{ fontSize: '16px' }}>3.그룹웨어 메일 개발 및 유지보수</b><br/>
                - 기술 스택: Linux, Spring Boot, React, MySQL, Git, k8s, MailEngine(SMTP, POP, IMAP), ElasticSearch, Kafka <br/>
                <br/>
                ...
                (4) 개발 및 유지보수 기여도 : 30%<br/>
                (5) 성과 : 기능 고도화 및 유지보수를 진행함으로써 사용자 편의 제공<br/>
                </pre>
                
                <pre className="career-text" style={{ backgroundColor: 'inherit', fontSize: '14px', border: 'none' }}>
                <b style={{ fontSize: '16px' }}>4. 그룹웨어 메일 개발 및 유지보수</b><br/>
                (1) 개발 기간 : 2024.06 ~ <br/>
                (2) 개발 인원 : 4명<br/>
                (3) 주요 개발 내역 : 메일 통계, 메일 탈취 감지, 메일 릴레이설정 사용자화, 스팸장비 연동 개발<br/>
                (4) 개발 및 유지보수 기여도 : 100%<br/>
                (5) 성과 : 신규기능 개발로 사용자 편의 제공 <br/>
                </pre>
