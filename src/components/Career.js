...
export default function Career() {
    ...
    const howIWork = [
        ...
        },
        {
            ...
            desc: "완전 자동화 대신, 시스템이 틀릴 수 있는 지점에 검증 게이트와 사람의 승인 노드를 배치합니다. JIRA-AI에서 담당자 지식을 승인 전에 격리하고, 외부 시스템에 쓰는 작업은 담당자 승인과 예약 시점 재확인을 거친 뒤에만 실행하는 이유입니다.",
            proof: "지식 승인 격리, DLT 지연 재접수, AI 패치 정적 검증 게이트",
        },
    ];
