...
export default function Career() {
    ...
    const stats = [
        { val: "6년차", lab: "총 개발 경력" },
        { val: "99.9%", lab: "SaaS 운영 가용성" },
        { val: "100k+", lab: "동시 접속 트래픽" },
        { val: "90% ↓", lab: "AI 조사 시간 단축" }
    ];
            ...
            <main className="container-main">
                        ...
                        <div className="flex flex-col lg:flex-row gap-12 lg:items-center">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                {stats.slice(1).map((stat, idx) => (
                                    <div key={idx} className="px-6 py-4 rounded-2xl bg-white/5 border border-white/5 text-center min-w-[140px]">
                                        <span className="block text-2xl font-bold text-[#0DA6F2]">{stat.val}</span>
                                        <span className="text-[10px] uppercase tracking-widest text-slate-500">{stat.lab}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
                ...
                <section className="mb-32">
                    ...
                    <div className="space-y-12">
                            ...
                            <div className="space-y-12">
                                ...
                                <div className="space-y-6">
                                    <SubProjectItem 
                                        ...
                                        result="망분리 환경에서의 안정적인 송수신과 통계 데이터를 통한 메일 탈치 및 의심계정 경고하여 CS적요소 차단"
                                    />
                                    <SubProjectItem 
                                        title="AWS S3 연동" 
                        ...
                        {/* Project Card 3: Military Service */}
                        <article className="premium-card group">
                            <div className="flex flex-col md:flex-row justify-between items-start mb-10 gap-6">
                                <div>
