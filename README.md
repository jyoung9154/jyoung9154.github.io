...
| `/resume-v3.html` | 상세 이력서(정적) — GitLab 커밋·diff로 검증한 항목만 기재, 미측정 수치 제외 |
| `/portfolio-v3.html` | 흐름도 포트폴리오(정적) — Mermaid 구조도·시퀀스·상태도 17개 |
| `/resume-v2.html` | 이전 상세 이력서(2026.07, 보존) |
